...
{
    public interface IUserPreferencesModel : INotifyPropertyChanged
    {
        /// <summary>
        ...
        /// <see cref="ProjectSortOptionName"/>
        /// </summary>
        string DocumentSortOptionName { get; set; }

        /// <summary>
        /// Name of selected sorting option that should be applied to entries
        /// on the <see cref="DocumentMetadata"/> list, with respect to each
        /// entry's parent project name. This sorting should be applied before
        /// <see cref="DocumentSortOptionName"/>
        /// </summary>
        string ProjectSortOptionName { get; set; }
    }
}
